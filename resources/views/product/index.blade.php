<x-app-layout>
    <main>
        <div>
            <div class="container">
                <h1 class="product-details-page-title">Мои товары</h1>
                            ...
                            <tr>
                                <td>
                                    <img
                                        ...
                                        alt=""
                                        class="my-items-img-thumbnail"
                                    />
                                </td>
                                <td>СК-ПУР Полиуретановая грунтовка для металла</td>
                                <td>2024-02-18</td>
                                <td>Да</td>
                                <td class="">
                                    <a
