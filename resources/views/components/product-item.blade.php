<div class="product-item card">
    <a href="{{ route('product.show', 1) }}">
        <img
            ...
            alt=""
            class="product-item-img rounded-t"
        />
    </a>
    <div class="p-medium">
