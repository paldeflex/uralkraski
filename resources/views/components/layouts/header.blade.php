<header class="navbar">
    <div class="container navbar-content">
        <a href="/" class="logo-wrapper">
            <img src="/img/logo-page.png" alt="Логотип"/>
        </a>
        ...
        <div class="navbar-auth">
            <a href="{{ route("product.create") }}" class="btn btn-add-new-item">
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
            ...
            <div class="navbar-menu" tabindex="-1">
                ...
                <ul class="submenu">
                    <li>
                        <a href="my_items.html">Мои товары</a>
                    </li>
                    <li>
                        <a href="watchlist.html">Мои избранные товары</a>
                    </li>
                    <li>
